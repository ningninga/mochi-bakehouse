...
const translations = {
  zh: {
    ...
    brandEyebrow: "限量预约",
    heroEyebrow: "不定期开单 · 数量有限 · 约满即止",
    heroTitle: "喜欢哪一款，先预约，本次开单名额有限",
    heroText: "这里是不定期开单的预约页面，不是每天都有现货。你可以先看看口味、价格、过敏原和本次可预约数量，选好后留下姓名和手机号预约就可以。",
    heroPrimaryCta: "查看可预约面包",
    heroSecondaryCta: "预约说明",
    highlightTitle: "预订提醒",
    highlightItem1: "不是每天开单，会按排期开放预约",
    highlightItem2: "每一轮预约数量有限，约满后就会显示不可预约",
    highlightItem3: "提交预约后，我会再和你确认制作与取货安排",
    highlightItem4: "取货地点：Dublin 2",
    introEyebrow: "预订方式",
  ...
  en: {
    pageTitle: "Mochi Bakehouse",
    brandEyebrow: "Limited Drop",
    heroEyebrow: "Occasional Drops · Limited Quantity · First Come, First Reserved",
    heroTitle: "See something you like? Reserve it before this drop fills up.",
    heroText: "This is an occasional preorder page rather than a daily stock shop. Browse flavors, pricing, allergens, and how many are still open for this release, then leave your name and phone number to reserve.",
    heroPrimaryCta: "View This Drop",
    heroSecondaryCta: "How It Works",
    highlightTitle: "Before You Order",
    highlightItem1: "Orders do not open every day and will be released in scheduled batches.",
    highlightItem2: "Each drop is limited and items become unavailable once fully reserved.",
    highlightItem3: "After you place a reservation, I will follow up to confirm baking and pickup details.",
    highlightItem4: "Pickup location: Dublin 2",
