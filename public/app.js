...
const translations = {
  zh: {
    ...
    highlightTitle: "欢迎来到我的小店",
    highlightItem1: "小批量手作，每一批都认真准备",
    highlightItem2: "会按排期不定期开单，数量有限",
    highlightItem3: "选好后留下联系方式，我会和你确认取货安排",
  ...
  en: {
    ...
    highlightTitle: "Welcome to my bakehouse",
    highlightItem1: "Small-batch handmade bakes, prepared with care.",
    highlightItem2: "New releases open occasionally and quantities are limited.",
    highlightItem3: "Choose your bakes and I'll follow up to confirm pickup details.",
